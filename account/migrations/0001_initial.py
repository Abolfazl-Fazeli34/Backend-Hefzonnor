    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('avatar', models.ImageField(blank=True, default='avatars/default.png', null=True, upload_to=account.models.avatar_upload_path)),
                ('avatar_thumbnail', models.ImageField(blank=True, null=True, upload_to=account.models.avatar_upload_path)),
            ],
            options={
                'abstract': False,
            },
